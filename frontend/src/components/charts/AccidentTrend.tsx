...
const CustomTooltip = ({ active, payload, label }: any) => {
  ...
  return (
    ...
    <div className="rounded-lg border border-[#E4E8F4] bg-white px-3 py-2 shadow-lg text-xs">
      ...
      <p className="mb-1 font-semibold text-[#6B7299]">
...
export function AccidentTrend({ data }: Props) {
  ...
  /*
    IMPORTANT:
    Prevents creating a new array reference
    on every parent render.

    Recharts receives the same data reference
    unless actual API data changes.
  */
